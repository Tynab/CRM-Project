        ...
        if (hasText(s)) {
            s = stringUtil
                    .removeSpCharsBeforeAndAfterSlash(stringUtil
                            .removeSpCharsBeforeAndAfterComma(StringUtils
                                    .capitalizeWords(replaceWordFoundByKeyword(
                                            replaceWordFoundByKeyword(
                                                    reformatViolateOneMinus(
                                                            stringUtil.removeSpCharsBeginAndEnd(
                                                                    s)),
                                                    ",", ", "),
                                            "\\.", "\\. "))));
            s = stringUtil.removeSpCharsBeforeAndAfterDot(reformatViolateSingleDot(
                    replaceWordFoundByKeyword(
